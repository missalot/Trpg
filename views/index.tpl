...
<div class="contain">
    <div class="operation">
        <button class="layui-btn layui-btn" id="add_monster">添加怪物</button>
        <button class="layui-btn layui-btn" id="add_player">添加玩家</button>
    </div>
    <div class="map_area">
    <img class="map" src="/static/img/map1.jpg" alt="地图" style="position: absolute;z-index: -1">
    </div>
</div>
<div id = "pl" hidden>
        ...
        <div class="layui-form-item" style="margin-top: 10px">
            ...
            <div class="layui-input-inline">
                <select id="monster_size" lay-verify="required" lay-search>
                    ...
                    <option value="/static/img/monsters/big/冬狼.png" >冬狼</option>
                    <option value="/static/img/monsters/big/凶暴熊.png" >凶暴熊</option>
                    <option value="/static/img/monsters/big/巨魔.png" >巨魔</option>
                    <option value="/static/img/monsters/big/牛头.png" >牛头</option>
                    <option value="/static/img/monsters/big/霜巨人.png" >霜巨人</option>
                    <option value="/static/img/monsters/big/风暴巨人.png" >风暴巨人</option>
                    <option value="/static/img/monsters/medium/僵尸.png" >僵尸</option>
                    <option value="/static/img/monsters/medium/兽人.png" >兽人</option>
                    <option value="/static/img/monsters/medium/凶暴狼獾.png" >凶暴狼獾</option>
                    <option value="/static/img/monsters/medium/塞壬.png" >塞壬</option>
                    <option value="/static/img/monsters/medium/女妖.png" >女妖</option>
                    <option value="/static/img/monsters/medium/宁芙.png" >宁芙</option>
                    <option value="/static/img/monsters/medium/提夫林.png" >提夫林</option>
                    <option value="/static/img/monsters/medium/狗头人.png" >狗头人</option>
                    <option value="/static/img/monsters/medium/紫蘑菇.png" >紫蘑菇</option>
                    <option value="/static/img/monsters/medium/骷髅.png" >骷髅</option>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
